...
export class DashboardAdminComponent {
  ...
  constructor(private fb: FormBuilder, private vueloServ: VuelosService, private aeroServ: AsientosService, private avionServ: AvionesService, private toastr: ToastrService) { }
  ...
  enviar() {
    ...
    this.vueloServ.postVuelo({ ...resto, estado: "A" })?.subscribe(
      res => {
        console.log(res)

        this.avionServ.postAvion({ modelo: ModeloAvion, estado: "A" })?.subscribe(
          avion => {
            console.log(avion)
        ...
        this.toastr.success('Vuelo guardao', 'Éxito')
      },
      err => {
